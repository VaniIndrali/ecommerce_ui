...
import 'package:ecommerce/views/someotherscreen.dart';
...
class TopCategoriesTile extends StatelessWidget {
  ...
  TopCategoriesTile(
      {@required this.imgAssetPath, this.label, this.color2, this.color1});
...
class BestSellingTile extends StatelessWidget {
  ...
  BestSellingTile(
      {@required this.noOfPeopleRated,
      @required this.starRating,
      @required this.title,
      @required this.price,
      @required this.imgaeAssetPath});
